...
// funcion para confirmar que agregamos un producto al carro
...
// Función para mostrar modal de confirmación basicamente que si quiere de verdar este pedido
function mostrarModalConfirmacion(titulo, mensaje, callback) {
  
    
    var modalHTML = `
        <div class="modal fade show" id="modalConfirmacion" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="false" style="display: block; background-color: rgba(0, 0, 0, 0.7);">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-warning">
                        <h5 class="modal-title" id="modalLabel" style="color: white; font-weight: bold;">${titulo}</h5>
                        <button type="button" class="btn-close" onclick="cerrarModalConfirmacion()" aria-label="Close"></button>
                    </div>
...
// Función para finalizar el pedido, aqui llamamos a la funciona anterior antes de proceder con el pedido
function finalizarPedido() {
    ...
    try {
        ...
        console.error("Error en finalizarPedido():", e);
