...
try {
    ...
    // --------------------------------------------------
    // 2. REDUCIR STOCK DE LOS PRODUCTOS COMPRADOS
    // --------------------------------------------------
    // Obtener todos los productos del carrito desde la BD
    ...
    error_log("Productos a comprar: " . count($productosComprados));
    ...
    foreach ($productosComprados as $producto) {
        ...
        error_log("Stock reducido para producto {$codProd}: {$unidades} unidades");
    }

    // --------------------------------------------------
    // 3. CREAR UN NUEVO CARRITO VACÍO PARA EL USUARIO
    // --------------------------------------------------
    ...
    error_log("ÉXITO: Pedido finalizado correctamente - Stock actualizado");
